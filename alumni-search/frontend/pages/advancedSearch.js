    ...
    if (jsCookie.get("username")) {
      ...
      return (
        <>
          ...
          <div>
          <button className = "category" onClick={this.toggleYearsMenu}>Search Graduation Year</button>
                {
          ...
          <button className = "category" onClick={this.toggleOccupationsMenu}>Search Occupations</button>
                {
                ...
                <button className = "category" onClick={this.toggleMajorsMenu}>Search Majors</button>
                {
              ...
              <button className= "category" onClick={() => that.clearSearchTerms()}>Clear</button>
